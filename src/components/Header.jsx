        ...
        <div className='bg-primary0 grid grid-cols-10 2xl:gap-10 items-center 2xl:p-10 xl:p-10 lg:p-10 md:p-4 p-2 relative z-10' style={{fontFamily: "font-inter"}}>
            ...
            <div className='col-start-1 col-end-3 flex items-center justify-start 2xl:gap-10 gap-4'>
              {props.title != "BATIK MANAGEMENT SYSTEM" ? (
                <button className='bg-secondary1 hover:bg-secondary0 duration-300 flex items-center justify-between gap-2 text-white py-2 px-6 rounded-xl' onClick={handleGoBack}>
            ...
            {/* HEADING TITLE */}
            <h1 className='col-start-3 col-end-9 2xl:text-[72px] xl:text-[62px] lg:text-[52px] md:text-[42px] sm:text-[32px] text-[20px] text-center gradient-text bg-clip-text text-transparent bg-gradient-to-r from-heading1 to-heading2 drop-shadow-2xl ' style={{fontFamily: 'font-upakarti'}}>{props.title}</h1>
            ...
            <div className='col-start-9 col-span-2 flex justify-end '>
              ...
              {user && <button onClick={handleLogout} className='bg-secondary1 hover:bg-secondary0 duration-300 rounded-xl shadow-xl text-white 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] text-[12px] 2xl:w-24 xl:w-24 lg:w-24 md:w-24 sm:w-20 w-14 2xl:py-2 py-1'>Logout</button>}
              {!user && <button onClick={handleLogin} className='bg-secondary1 hover:bg-secondary0 duration-300 rounded-xl shadow-xl text-white 2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] text-[12px] 2xl:w-24 xl:w-24 lg:w-24 md:w-24 sm:w-20 w-14 2xl:py-2 py-1'>Login</button>}
            </div>
        </div>
