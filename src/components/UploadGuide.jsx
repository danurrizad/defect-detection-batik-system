      ...
      return (
        <div className='bg-heading2 w-2/3 2xl:min-h-[400px] min-h-[250px] rounded-xl shadow-sm shadow-black' style={{ fontFamily: 'font-inter' }}>
          <div className='flex mb-4 w-full justify-between gap-0'>
              <button
                className={`w-full px-4 py-2 bg-${selectedTab === 'upload' ? 'secondary1' : 'gray'} text-white rounded-tl-xl shadow-sm shadow-black hover:bg-secondary1`}
                onClick={() => toggleTab('upload')}
              >
                Panduan Upload File CSV
              </button>
              <button
                className={`w-full px-4 py-2 bg-${selectedTab === 'expo' ? 'secondary1' : 'gray'} text-white rounded-tr-xl shadow-sm shadow-black hover:bg-secondary1`}
